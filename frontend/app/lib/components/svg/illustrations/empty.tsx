...
/**
 * NotFoundIllustration - иллюстрация для страницы 404
 * Адаптивный SVG компонент с переменными темы
 * @param props - стандартные пропсы для SVG элемента
 */
  ...
  return (
    ...
    >
      ...
      <path
        ...
        transform="translate(-263.73425 -80.80301)"
        fill="hsl(var(--heroui-secondary-300))"
      />
      <ellipse
        cx="763.7883"
        cy="737.32189"
      ...
      <circle
        ...
        fill="hsl(var(--heroui-primary-900))"
      />
      <circle cx="542" cy="697.39398" r="6" fill="hsl(var(--heroui-info-50))" />
      <path
