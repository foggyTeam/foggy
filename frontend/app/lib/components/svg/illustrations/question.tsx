...
/**
 * Questions Illustration component
 * Represents a question mark with people figures
 * Uses CSS variables to adapt to the current theme
 */
export default function QuestionsIllustration(
