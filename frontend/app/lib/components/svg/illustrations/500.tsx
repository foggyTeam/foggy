...
// Иллюстрация "Server Down" как React-компонент
// Цвета заменены на CSS-переменные для динамической темы
// Вместо статических цветов используем переменные Heroui
// Можно применять классы и стили через props
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="hsl(var(--heroui-primary-800))"
      />
      <path
      ...
      <ellipse
        ...
        rx="187"
        ry="25.43993"
        fill="hsl(var(--heroui-primary-900))"
      />
      ...
      <path
        ...
        transform="translate(-31.39089 -100.5)"
        fill="none"
        stroke="hsl(var(--heroui-primary-800))"
        strokeMiterlimit="10"
        strokeWidth="2"
      />
      <path
