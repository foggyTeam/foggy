...
/**
 * SearchDocumentsIllustration - SVG illustration showing search/find documents concept
 * Uses CSS variables to adapt to theme (light/dark mode)
 * @param props - Standard SVG element props
 */
export default function SearchDocumentsIllustration(
