...
// Иллюстрация "Creative" с адаптивными цветами для темной/светлой темы
// Все цвета заменены на CSS-переменные темы Heroui
export default function CreativeIllustration(
